...
useEffect(() => {
  ...
  const initiateVideoCall = (roomName) => {
    const domain = 'meet.jit.si';
    const options = {
      roomName: roomName || `Room-${Math.random().toString(36).substring(7)}`, 
      width: '100%',
      height: 600,
      parentNode: videoCallRef.current,  
	...
	return (
			...
			<div className='w-[50%] h-screen bg-white flex flex-col items-center'>
				{
					...
					<div className='w-[75%] bg-secondary h-[80px] my-14 rounded-full flex items-center px-14 py-2'>
						...
						<div className='cursor-pointer' onClick={() => initiateVideoCall('group-chat-room')}>
        ...
        <div ref={videoCallRef} className='w-full h-[600px]'></div>
